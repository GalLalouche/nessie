...
import com.nessie.gm.{AbilityToTurnActionConverter, Attack, Movement, TurnAction}
import com.nessie.gm.TurnAction.{ActualAction, MovementAction}
import com.nessie.model.map.MapPoint

object AbilityToTurnAction extends AbilityToTurnActionConverter {
  override def apply(ability: UnitAbility)(src: MapPoint, dst: MapPoint): TurnAction = ability match {

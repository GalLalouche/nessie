...
private case class TunnelMapObject(indexNumber: Int) extends AlgorithmStepMapObject
private case class ReachableMapObject(index: Int) extends AlgorithmStepMapObject
